...
public class GPUSkinningPlayerMonoManager
{
	...
	public void Register(GPUSkinningAnimation anim, Mesh mesh, Material originalMtrl, Texture2D boneTexture, GPUSkinningPlayerMono player, out GPUSkinningPlayerResources resources)
	{
		resources = null;
		...
		if (item.boneTexture == null)
		{
			item.boneTexture = boneTexture; //GPUSkinningUtil.CreateTexture2D(textureRawData, anim);
		}
